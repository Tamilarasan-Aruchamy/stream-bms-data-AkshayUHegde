...
TEST_CASE("Test the wrong Input Message") 
{
	...
	char BSM_InputMessage_TestData_2[15][100]={"{\"charge_rate\": 8.69, \"temp_in_c\": 15.26}",\
                                    "{\"charge_ratee\": 1.69, \"temp_in_c\": 16.26}",   /* Invalid Message (Wrong Name in change_rate). this will not consisder for Min,Max and Avg calculation */ \
                                    "{\"charge_rate\": 2.69, \"temp_in_ca\": 121.26}",   /* Invalid Message(Wrong Name in temp_in_c). this will not consisder for Min,Max and Avg calculation */ \
                                    "{\"charge_rate\": 3.69, \"temp_in_c\": 18.26}",\
                                    "{\"charge_rate\": 4.69, \"temp_in_c\": 19.26}",\
                                    "{\"charge_rate\": 5.69, \"temp_in_c\": 110.26}",\
                                    "{\"charge_rate\": 6..69, \"temp_in_c\": 111.26}",   /* Invalid Message(Wrong value format in change_rate). this will not consisder for Min,Max and Avg calculation */ \
                                    "{\"charge_rate\": 7.69, \"temp_in_c\": 112.26}",\
                                    "{\"charge_rate\": 8.69, \"temp_in_c\": 113.26}",\
                                    "{\"charge_rate\": 9.69, \"temp_in_c\": b114.26}",   /* Invalid Message(Wrong value format in temp_in_c). this will not consisder for Min,Max and Avg calculation */ \
                                    "{\"charge_rate\": 10.69, \"temp_in_c\": 115.26}",\
                                    "\"charge_rate\": 11.69, \"temp_in_c\": 116.26}",   /* Invalid Message(Missing '{'). this will not consisder for Min,Max and Avg calculation */ \
                                    "{\"charge_rate\": 12.69, \"temp_in_c\": 11-7.26}",  /* Invalid Message(Wrong value format in temp_in_c). this will not consisder for Min,Max and Avg calculation */ \
                                    "{\"charge_rate\": 13.69, \"temp_in_c\": 118.26",   /* Invalid Message(Missing '}'). this will not consisder for Min,Max and Avg calculation */ \
                                    "{\"charge_rate\": 14.69, \"temp_in_c\": 19.26 \"voltage\": 19.26}"};  /* Invalid Message (Added new Signal). this will not consisder for Min,Max and Avg calculation */ 
	...
	REQUIRE(BSM_SignalReceiver()==0);
	REQUIRE(printf_Func_CallCount==7);
	REQUIRE(scanf_Func_CallCount==15);
