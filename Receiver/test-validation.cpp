...
TEST_CASE("Test the Number scanf function calls") 
{
	...
	char BSM_InputMessage[15][100]={"{\"charge_rate\": 11.69, \"temp_in_c\": 5.26}",\
                                    "{\"charge_rate\": 12.69, \"temp_in_c\": 6.26}",\
                                    "{\"charge_rate\": 12.69, \"temp_in_c\": 7.26}",\
                                    "{\"charge_rate\": 14.69, \"temp_in_c\": 8.26}",\
                                    "{\"charge_rate\": 15.69, \"temp_in_c\": 9.26}",\
                                    "{\"charge_rate\": 16.69, \"temp_in_c\": 10.26}",\
                                    "{\"charge_rate\": 17.69, \"temp_in_c\": 11.26}",\
                                    "{\"charge_rate\": 18.69, \"temp_in_c\": 12.26}",\
                                    "{\"charge_rate\": 44.69, \"temp_in_c\": 13.26}",\
                                    "{\"charge_rate\": 23.69, \"temp_in_c\": 14.26}",\
                                    "{\"charge_rate\": 5.69, \"temp_in_c\": 15.26}",\
                                    "{\"charge_rate\": 6.69, \"temp_in_c\": 16.26}",\
                                    "{\"charge_rate\": 7.69, \"temp_in_c\": 17.26}",\
                                    "{\"charge_rate\": 8.69, \"temp_in_c\": 18.26}",\
                                    "{\"charge_rate\": 9.69, \"temp_in_c\": 19.26}"};
...
TEST_CASE("Test the Min Max and Avg") 
{
	...
	MinMaxAvg Expected_MinMaxAvg[15][2]={{{18.69,18.69,3.738000},{5.26,5.26,1.052000}},\
						{{9.69,18.69,5.676000},{5.26,6.26,2.304000}},\
					       ...
					       {{9.69,30.69,20.690001},{5.26,21.26,17.260000}}};
...
TEST_CASE("Test the wrong Input Message") 
{
	...
	MinMaxAvg Expected_MinMaxAvg[11][2]={{{8.69,8.69,1.738000},{15.26,15.26,3.052000}},\
						{{3.69,8.69,2.476000},{15.26,18.26,6.704000}},\
					       ...
					       {{3.69,11.69,8.890000},{15.26,116.26,113.459999}},\
					       {{3.69,12.69,10.290000},{15.26,117.26,114.860001}},\
					       {{3.69,13.69,11.490000},{15.26,118.26,116.059998}},\
					       {{3.69,14.69,12.690001},{15.26,119.26,117.259995}}};
